...
params ["_spikes", "_size", "_time", "_intervall", "_cloudLifetime"];
...
{
	{
		drop [["\A3\data_f\ParticleEffects\Universal\Universal_02.p3d",8,0,40,1], "", "Billboard", 1, _cloudLifetime, [0,0,0], [0,0,0], 0.1, 10,7.84, 0.1, [_size], [_color,_colorTarget], [0.2,0.2], 2, 0.1, "", "", _x, random(360)/(2 * pi), false, 1, [_color,_colorTarget]];
	} forEach _spikes;
	sleep _intervall;
};