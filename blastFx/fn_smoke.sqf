...
_smoke setParticleParams [["\A3\data_f\ParticleEffects\Universal\Universal_02.p3d",8,0,40,0], "", "Billboard", 1, _lifetime, [0,0,0], [0,0,0], 0, 20,7.84, 0, [_size], [_color,_colorTarget], [0.2,0.2], 2, 0, "", "", _object, random(360)/(2 * pi), true, -1.0, [_color,_colorTarget]];

//drop smoke particles
for "_i" from 1 to _steps do
{
	_smoke setParticleCircle [20/*_size / 2 + (_size * (_i - 1))*/, [0,0,0]];
